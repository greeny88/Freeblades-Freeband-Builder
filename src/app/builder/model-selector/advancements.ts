...
const AdvancementTalents: string[] = [
    'Accurate Shot',
    'Accurate Strike',
    'Active Defense',
    'Adapt the Plan',
...
export  {Abilities, Equipment, MagicItems, MeleeWeapons, RangeWeapons, Skills, AdvancementTalents, OtherTalents};